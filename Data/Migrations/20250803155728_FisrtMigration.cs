    ...
    public partial class FisrtMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__users__3214EC074A6650BE", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Content__3214EC072B3FA708", x => x.Id);
                    table.ForeignKey(
                        name: "FK__Content__Uploade__3D5E1FD2",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RateAmount = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Rating__3214EC07FF69D4BA", x => x.Id);
                    table.ForeignKey(
                        name: "FK__Rating__ContentI__4316F928",
                        column: x => x.ContentId,
                        principalTable: "Content",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK__Rating__UserId__4222D4EF",
                        column: x => x.UserId,
                        principalTable: "users",
                        principalColumn: "Id");
                });
